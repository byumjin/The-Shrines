...
class OpenGLRenderer {
    constructor(canvas) {
        ...
        this.translucentAddPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/translucentAdd-frag.glsl')));
        this.SSRPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/SSR-frag.glsl')));
        this.SSRMipPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/SSRMip-frag.glsl')));
        this.savePass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/save-frag.glsl')));
        this.highLightPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/highLight-frag.glsl')));
        this.VblurPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/Blur_Vertical-frag.glsl')));
        this.HblurPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/Blur_Horizontal-frag.glsl')));
        ...
        this.presentPass = new PostProcess(new Shader(gl.FRAGMENT_SHADER, require('../../shaders/present-frag.glsl')));
